...
public class Lane {
    ...
    public Rectangle spawn_car(Cardinal dir) {
        ...
        if (is_bus){
            ...
            c = (Car) new Car(direction, spawn_position_x, spawn_position_y, Cardinal.toDirection(dir), center_x, center_y);
        }
            ...
            // if the car has reached the junction, and the light is green, start turning
                ...
                if (vehicle instanceof Car) { // buses do not turn so they are handled differently
                    ...
                    if (Road.isLeftOf(Direction.toCardinal(this.direction),Direction.toCardinal(car.getOutboundDirection()))) {
                        car.getAnimations().turn_left(car, car.getInboundDirection(), x+car.getInboundDirection().getRight_turn_pos_x(), y+car.getInboundDirection().getRight_turn_pos_y(), lanes_in_road, max_lane_out);
                    }
                    
                    // make the car turn right
                    else if (Road.isRightOf(Direction.toCardinal(this.direction),Direction.toCardinal(car.getOutboundDirection()))) {
                        car.getAnimations().turn_right(car, car.getInboundDirection(), x+car.getInboundDirection().getRight_turn_pos_x(),y+car.getInboundDirection().getRight_turn_pos_y());
                    }
